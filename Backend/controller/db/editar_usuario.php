...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    $template_id = mysqli_real_escape_string($conect->conectarBD(), $_POST['template_id']);
    ...
    if ($contra) {
        $consulta = "UPDATE acceso SET nombre='$template_nombre', mail='$template_email', tipo='$template_tipo', acceso='$template_acceso', contra='$contra' WHERE id='$template_id'";
    } else {
        $consulta = "UPDATE acceso SET nombre='$template_nombre', mail='$template_email', tipo='$template_tipo', acceso='$template_acceso' WHERE id='$template_id'";
    }
