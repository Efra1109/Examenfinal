...
<ul id="slide-out" class="sidenav sidenav-fixed">
  <li style="height: auto;">
    <div class="user-view" style="width: 100%;">
      <div class="row center">
        <div class="col s12">
        <i class="material-icons large IconColor">security</i>
        </div>
      </div>
    </div>
  </li>
  ...
  <li><a id="n1" href="index.php"><i id="i1" class="material-icons">comment</i>Data</a></li>
  <li><a id="n2" href="Dashboard.php"><i id="i2" class="material-icons">dashboard</i>Dashboard</a></li>
  <li><a id="n9" href="./usuario.php"><i id="i9" class="material-icons">assignment_ind</i>Usuarios</a></li>
