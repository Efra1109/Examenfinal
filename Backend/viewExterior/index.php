...
<div class="row animated fadeIn" style="margin-bottom: 0;"><!-- row principal-->
  ...
  <div class="row center" style="margin-top: 25vh;">
    <div class="col s12">
      <a class="material-icons large IconColor">security</a>
      <h4 style="color: black;">Devel</h4>
      ...
      <form id="login" accept-charset="utf-8" action="">
        ...
        <div class="col s12 m8">
          <div class="input-field col s11 m8">  
            ...
            <!--Esto suma los valores para luego validar si es igual a lo que escribamos-->
  ...
  <div class="row center">
    <div class="col s12" style="position: fixed; bottom: 0;">
      <span class="black-text" style="font-size: 20px;"> Devel cibersecurity <a class="black-text" href=""></a></span>
    </div>
  </div>
  <!-- Derechos reservados -->
