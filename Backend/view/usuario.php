...
<center>Usuario</center>
  ...
  <form class="col s12" method="post" id="EditarUsuario">
                    ...
                    <div class="row nomargin">
                        <div class="input-field col s11">
                            <select id="template_tipo" name="template_tipo">
                                ...
                                <option value="Analista">DEFRAUDADOR</option>
                            </select>
    ...
    <div class="row">
      ...
      <div class="input-field col s6">
        <input placeholder="Ingrese la contrseña" id="template_contra" name="template_contra" type="password">
    ...
    <div class="row">
        ...
        <!-- Campo aculto para el id -->
        <input type="" id="id_usuario" name="id_usuario" value="<?php echo $template_id; ?>">
